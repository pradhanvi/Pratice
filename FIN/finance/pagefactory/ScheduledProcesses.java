...
public class ScheduledProcesses extends TestBase {
	...
	@FindBy(id = "pt1:USma:0:MAnt1:0:pt1:panel:scheduleProcess")
	...
	@FindBy(id = "pt1:USma:0:MAnt1:0:pt1:srRssdfl:value10::content")
	public WebElement ProcessID;

	@FindBy(id = "pt1:USma:0:MAnt1:0:pt1:srRssdfl::search")
