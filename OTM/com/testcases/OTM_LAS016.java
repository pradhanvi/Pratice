...
public class OTM_LAS016 extends TestBase {
	...
	public void f() throws Throwable {
		...
		rpt = new ReportGeneration("OTM_LAS016_Hw_to_Crte_Blk_Pln","");
		...
		if (homepage != null) {
			rpt.generateReport("OTM_LAS016_How_to_Create_Bulk_Plan", "Enter Username", "",
		...
		for (int dataRow = 1; dataRow < exl.getRowCount(sheetName); dataRow++) {
			...
			if (parentElement != null) {
				...
				throw new SkipException(parentNode + "not clicked");
			}
			...
			if (childElement != null) {
				...
				throw new SkipException(childNode + "not clicked");
			}

			// Click link
			boolean result = orderReleaseResult.selectLinkUnderNode(childElement,
					link);
