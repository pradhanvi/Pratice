...
/**
Script Name			: SCM_CHILE_MFG_008_Manage_Work_Definitions
Script Description	: Manage Work Definition
Track/Module		: SCM
Sub Track			: 
...
public class SCM_CHILE_MFG_008_Manage_Work_Definitions extends TestBase{
	String strModule = "SCM";
	@Test
	public void SCM_CHILE_MFG_008_Manage_Work_Definitions() throws Throwable {
		rpt = new ReportGeneration("SCM_CHILE_MFG_008_Manage_Work_Definitions", "Manage Work Definition");

		String strDataSheetName = "MFG_008";
		boolean login = false;
		...
		if(cmnLib.waitForElementToBeVisible(homePage_SCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("SCM_CHILE_MFG_008_Manage_Work_Definitions", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", false );
		...
		{
			//FAIL
			rpt.generateReport("SCM_CHILE_MFG_008_Manage_Work_Definitions", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Searching for an Item
			...
			cmnLib.enterDataInTextBox(manageWorkDefinition.Item_Search, exl.read(strDataSheetName, dataRow, "Item_Search"), true);
			cmnLib.clickOnWebElement(manageWorkDefinition.SearchButton);
			TimeUnit.SECONDS.sleep(2);
			
			if(manageWorkDefinition.verifySearchedRecordExists(exl.read(strDataSheetName, dataRow, "Item_Search")))
			{
		...
		//Selecting the item
			...
			if(manageWorkDefinition.selectingItem(exl.read(strDataSheetName, dataRow, "Item_Search")))
			{
				TimeUnit.SECONDS.sleep(5);
				if(cmnLib.waitForElementToBeVisible(manageWorkDefinition.EditWindow_CancelButton))
				{
			...
			cmnLib.clickOnWebElement(manageWorkDefinition.EditWindow_CancelButton);
			TimeUnit.SECONDS.sleep(2);
			
		//Adding New Work Definition
			rpt.enterStepHeader("Adding New Work Definition");
			
			cmnLib.clickOnWebElement(manageWorkDefinition.Add_WorkDefinition);
			TimeUnit.SECONDS.sleep(2);
			
			if(cmnLib.waitForElementToBeVisible(manageWorkDefinition.Item_WorkDefinition))
			{
				cmnLib.enterDataInTextBox(manageWorkDefinition.Item_WorkDefinition, exl.read(strDataSheetName, dataRow, "Item_Name"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.Name_WorkDefinition, exl.read(strDataSheetName, dataRow, "Name_WorkDefinition"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.Version_WorkDefinition, exl.read(strDataSheetName, dataRow, "Version"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.ProductionPriority_WorkDefinition, exl.read(strDataSheetName, dataRow, "Production_priority"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.clickOnWebElement(manageWorkDefinition.Next_WorkDefinition);
				
				rpt.generateReport("", "Create Work Definition", "", "", "Must be Able to enter data ", "Able to enter data", "Passed", "", true );
				
				cmnLib.clickOnWebElement(manageWorkDefinition.Add_Operations);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.Sequence_WorkDefinition, exl.read(strDataSheetName, dataRow, "Sequence"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.selectDropdownBy(manageWorkDefinition.Operations_Type, exl.read(strDataSheetName, dataRow, "Operation_Type"), DropDownSelectBy.VisibleText);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.Name_Operations, exl.read(strDataSheetName, dataRow, "Name_Operation"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.enterDataInTextBox(manageWorkDefinition.WorkCenter_WorkDefinition, exl.read(strDataSheetName, dataRow, "Work_Centers"), true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.clickOnWebElement(manageWorkDefinition.CountPointCheckbox);
				
				rpt.generateReport("", "Create Work Definition", "", "", "Must be Able to enter work definition operations data ", "Able to enter work definition operations data", "Passed", "", true );
				cmnLib.clickOnWebElement(manageWorkDefinition.Save_WorkDefinition);
			}else {
				
				rpt.generateReport("", "Create Work Definition page", "", "", "Must be Able to open Create Work Definition page", "Not Able to open Create Work Definition page", "Failed", "", true );
				Assert.fail("Not Able to open Create Work Definition page");
			}
			rpt.generateReport("", "Create Work Definition", "", "", "Edit page must be opened", "Edit page is opened", "Passed", "", true );
			cmnLib.clickOnWebElement(manageWorkDefinition.SaveCloseButton_Edit);
			TimeUnit.SECONDS.sleep(2);
