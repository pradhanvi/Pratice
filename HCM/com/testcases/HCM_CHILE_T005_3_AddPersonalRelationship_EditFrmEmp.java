...
/**
Script Name			: HCM_CHILE_T005_3_AddPersonalRelationship_EditFrmEmp
Script Description	: Add Relationship - Edit Personal Relationship from Emp Login
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T005_3_AddPersonalRelationship_EditFrmEmp extends TestBase{

	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T005_3_AddPersonalRelationship_EditFrmEmp_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T005_3_AddPersonalRelationship", "Edit Relationship from Employee");

		String strDataSheetName = "T005_3_AddPersoRelatshp";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T005_3_AddPersonalRelationship_EditFrmEmp", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T005_3_AddPersonalRelationship_EditFrmEmp", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Click on Contacts Tab
			...
			driver.findElement(By.xpath("//span[text()='"+exl.read(strDataSheetName, dataRow, "ContactToEdit")+"']")).click();
			TimeUnit.SECONDS.sleep(3);
			cmnLib.clickOnWebElement(personalInformation.EditContactICon);
			
			if(cmnLib.waitForElementToBeVisible(personalInformation.UpdateDate))
			{
				rpt.generateReport("", "Edit My Details:Contacts page", "", "", "Relationship details should appear", "Relationship details before editing", "Passed", "", true);
				
				if(personalInformation.selectValueFromInputComboBox("Relationship", "Contact"))
					System.out.println("Relationship type is selected");
				cmnLib.enterDataInTextBox(personalInformation.UpdateDate, cmnLib.futureDate("dd/MMM/YYYY", 0), true);
				...
				{
					rpt.generateReport("", "Edit Address", "", "", "Personal Contact is edited to his/her details","Personal Contact details are Saved Successfully", "Passed", "", true);
				}else {
					
					rpt.generateReport("", "Edit Address", "", "", "Personal Contact is edited to his/her details", "Failed to edit Personal Contact", "Failed", "", true);
			...
			if(cmnLib.waitForElementToBeVisible(personalInformation.PersonalInformationHeader, 10))
				rpt.generateReport("", "Edit Address", "", "", "Personal Contact is edited to his/her details","Personal Contact is edited Successfully", "Passed", "", true);
