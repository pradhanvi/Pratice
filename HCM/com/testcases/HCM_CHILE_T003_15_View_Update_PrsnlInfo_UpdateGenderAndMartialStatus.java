...
/**
Script Name			: HCM_CHILE_T003_15_View_Update_PrsnlInfo_UpdateGenderAndMartialStatus
Script Description	: View and Update Personal Information - Update Gender and Martial status
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_15_View_Update_PrsnlInfo_UpdateGenderAndMartialStatus extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_15_View_Update_PrsnlInfo_UpdateGenderAndMartialStatus_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_15_View_Update_PrsnlInfo", "Update Gender and Martial status");

		String strDataSheetName = "T003_15_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_15_View_Update_PrsnlInfo_UpdateGenderAndMartialStatus", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_15_View_Update_PrsnlInfo_UpdateGenderAndMartialStatus", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Update Gender and Martial status
				
				managePerson.clickGenderMartialStatusEditSelectUpdate();
				...
				rpt.generateReport("", "Update Gender and Martial status", "", "", "Should Enter all the required details", "All the required details are entered", "Passed", "", true);
				TimeUnit.SECONDS.sleep(3);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Update Gender and Martial status", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Update Gender and Martial status", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Update Gender and Martial status", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
