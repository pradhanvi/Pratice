...
/**
Script Name			: HCM_CHILE_T003_18_View_Update_PrsnlInfo_DeleteRecordAndMartialStatus
Script Description	: View and Update Personal Information - Delete Record Gender and Martial status
Track/Module		: OTM
Sub Track			: 
...
public class HCM_CHILE_T003_18_View_Update_PrsnlInfo_DeleteRecordAndMartialStatus extends TestBase{


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_18_View_Update_PrsnlInfo_DeleteRecordAndMartialStatus_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_18_View_Update_PrsnlInfo", "Delete Record Gender and Martial status");

		String strDataSheetName = "T003_18_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_18_View_Update_PrsnlInfo_DeleteRecordAndMartialStatus", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_18_View_Update_PrsnlInfo_DeleteRecordAndMartialStatus", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Delete Record Gender and Martial status
				
				managePerson.clickGenderMartialStatusEditSelectDeleteRecord();
				
				
				cmnLib.waitForElementToBeVisible(managePerson.DeletePopupMessage, 30);
				cmnLib.clickOnWebElement(managePerson.DeletePopupMessage);
				...
				cmnLib.clickOnWebElement(managePerson.DeletePopupMessageYesButton);
