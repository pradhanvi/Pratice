...
/**
Script Name			: HCM_CHILE_T003_5_View_Update_PrsnlInfo_CorrectAddress
Script Description	: View and Update Personal Information - Correct Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_5_View_Update_PrsnlInfo_CorrectAddress extends TestBase {
	...
	@Test
	public void HCM_CHILE_T003_5_View_Update_PrsnlInfo_CorrectAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_5_View_Update_PrsnlInfo", "Correct Address");

		String strDataSheetName = "T003_5_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_5_View_Update_PrsnlInfo_CorrectAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_5_View_Update_PrsnlInfo_CorrectAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Selecting Options from Edit dropdown
				...
				managePerson.clickAddressEditSelectCorrect();
		...
		//Correcting address
				...
				rpt.generateReport("", "Correct address", "", "", "Must Enter all the details", "All the details entered successfully", "Passed", "", true);
				TimeUnit.SECONDS.sleep(3);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Correct address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Correct address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Correct address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
