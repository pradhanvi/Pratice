...
/**
Script Name			: HCM_CHILE_TS004_Create_Action_SetupAndMaintanence
Script Description	: Create Action from Setup And Maintenance
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_TS004_Create_Action_SetupAndMaintanence extends TestBase {
	...
	@Test
	public void HCM_CHILE_TS004_Create_Action_SetupAndMaintanence_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_TS004_Create_Action", "");

		String strDataSheetName = "TS004_Crt_Action";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_TS004_Create_Action_SetupAndMaintanence", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_TS004_Create_Action_SetupAndMaintanence", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
