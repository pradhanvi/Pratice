...
/**
Script Name			: HCM_CHILE_TS002_Edit_Salary_Basis
Script Description	: Edit Salary Basis
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_TS002_Edit_Salary_Basis extends TestBase{

	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_TS002_Edit_Salary_Basis() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_TS002_Edit_Salary_Basis", "");

		String strDataSheetName = "TS002_Edit_SalBasis";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_TS002_Edit_Salary_Basis", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_TS002_Edit_Salary_Basis", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Search Task
			...
			cmnLib.clickOnLinkText(exl.read(strDataSheetName, dataRow, "Salary_Name"));
			
			
			if(cmnLib.waitForElementToBeVisible(setupAndMaintenance.EditSalaryBasisHeader,10))
			{
				rpt.generateReport("", "Edit Salary Basis", "", "", "Edit Salary page must open", "Create Salary page is opened", "Passed", "", true );
			}else {
				rpt.generateReport("", "Edit Salary Basis", "", "", "Edit Salary page must open", "Create Salary page NOT opened", "Failed", "", true );
			...
			rpt.generateReport("", "Edit Salary Basis", "", "", "All the values must be entered", "Values are entered", "Passed", "", true );
			...
			{
				rpt.generateReport("", "Edit Salary Basis", "", "", "Salary Basis should be Edited", "Salary Basis is Edited", "Passed", "", true );
			}else {
				rpt.generateReport("", "Edit Salary Basis", "", "", "Salary Basis should be Edited", "Salary Basis is NOT Edited", "Failed", "", true );
				Assert.fail("Salary Basis is NOT Edited");
			}
