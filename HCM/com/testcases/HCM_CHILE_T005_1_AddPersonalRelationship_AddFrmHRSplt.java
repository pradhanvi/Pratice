...
/**
Script Name			: HCM_CHILE_T005_1_AddPersonalRelationship_AddFrmHRSplt
Script Description	: Add Relationship - Add Personal Relationship from HR Specialist
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T005_1_AddPersonalRelationship_AddFrmHRSplt extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T005_1_AddPersonalRelationship_AddFrmHRSplt_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T005_1_AddPersonalRelationship", "Add Personal Relationship from HR Specialist");

		String strDataSheetName = "T005_1_AddPersoRelatshp";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T005_1_AddPersonalRelationship_AddFrmHRSplt", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T005_1_AddPersonalRelationship_AddFrmHRSplt", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Personal Relationship
				...
				cmnLib.clickOnWebElement(manageContact.CreateContactIcon);
				
				cmnLib.waitForElementToBeVisible(manageContact.ContactEffectiveDate, 20);
				manageContact.selectValueFromInputComboBox("Contact Type", exl.read(strDataSheetName, dataRow, "ContactType"));
				...
				cmnLib.clickOnWebElement(manageContact.CreatePhoneIcon);
				cmnLib.waitForElementToBeVisible(manageContact.TypeDrop, 15);
				...
				cmnLib.clickOnWebElement(manageContact.ContactAddRadioButton);
				cmnLib.clickOnWebElement(manageContact.ContactAddRadioButton);
				
				rpt.generateReport("", "Add Personal relationship contact details", "", "", "Should Enter all the required details", "All the required details are entered", "Passed", "", true);
				TimeUnit.SECONDS.sleep(3);
				cmnLib.clickOnWebElement(manageContact.CreateContactOKButton);
				TimeUnit.SECONDS.sleep(5);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Add Personal relationship contact", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Add Personal relationship contact", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(manageContact.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Add Personal relationship contact", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
