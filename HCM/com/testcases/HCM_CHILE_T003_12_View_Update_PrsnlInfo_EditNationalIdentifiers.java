...
/**
Script Name			: HCM_CHILE_T003_12_View_Update_PrsnlInfo_EditNationalIdentifiers
Script Description	: View and Update Personal Information - Edits National Identifiers
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_12_View_Update_PrsnlInfo_EditNationalIdentifiers extends TestBase{

	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_12_View_Update_PrsnlInfo_EditNationalIdentifiers_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_12_View_Update_PrsnlInfo", "Edits National Identifiers");

		String strDataSheetName = "T003_12_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_12_View_Update_PrsnlInfo_EditNationalIdentifiers", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_12_View_Update_PrsnlInfo_EditNationalIdentifiers", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Update National Identifier
					cmnLib.clickOnWebElement(managePerson.EditNationalIDentifier);
					TimeUnit.SECONDS.sleep(2);
					cmnLib.clickOnWebElement(managePerson.NationalIDDrop);
					TimeUnit.SECONDS.sleep(2);
					cmnLib.clickOnWebElement(managePerson.NationalIDType);
					cmnLib.clickOnWebElement(managePerson.EditNationalIdentifier);
					cmnLib.waitForElementToBeVisible(managePerson.NationalIDNumber, 10);
					cmnLib.enterDataInTextBox(managePerson.NationalIDNumber, exl.read(strDataSheetName, dataRow, "NationalIDNumber"), true);
					rpt.generateReport("", "Update National Identifier", "", "", "Enter all the required details", "All the required details are entered", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.NationalIDOK);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Update National Identifier", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Update National Identifier", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Update National Identifier", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
