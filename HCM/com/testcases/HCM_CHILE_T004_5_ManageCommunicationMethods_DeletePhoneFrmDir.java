...
/**
Script Name			: HCM_CHILE_T004_5_ManageCommunicationMethods_DeletePhoneFrmDir
Script Description	: Manage Communication Methods - Delete Phone num frm Directory
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_5_ManageCommunicationMethods_DeletePhoneFrmDir extends TestBase {
	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T004_5_ManageCommunicationMethods_DeletePhoneFrmDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_5_ManageCommunicationMethods", "Delete Phone num frm Directory");

		String strDataSheetName = "T004_5_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_5_ManageCommunicationMethods_DeletePhoneFrmDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_5_ManageCommunicationMethods_DeletePhoneFrmDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
