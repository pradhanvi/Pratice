...
/**
Script Name			: HCM_CHILE_T003_3_View_Update_PrsnlInfo_CreateAddress
Script Description	: View and Update Personal Information - Create Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_3_View_Update_PrsnlInfo_CreateAddress extends TestBase{
	...
	@Test
	public void HCM_CHILE_T003_3_View_Update_PrsnlInfo_CreateAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_3_View_Update_PrsnlInfo", "Create Address");

		String strDataSheetName = "T003_3_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_3_View_Update_PrsnlInfo_CreateAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_3_View_Update_PrsnlInfo_CreateAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Click on Create button
				cmnLib.clickOnWebElement(managePerson.Create_Address);
				TimeUnit.SECONDS.sleep(3);
				managePerson.EffectiveStartDate_Address.clear();
				managePerson.EffectiveStartDate_Address.sendKeys(managePerson.futureDate("dd/MMM/YYYY",0));
				managePerson.selectValueFromInputComboBox("Type", exl.read(strDataSheetName, dataRow, "Type"));
				cmnLib.enterDataInTextBox(managePerson.Country_Address, exl.read(strDataSheetName, dataRow, "Country"), true);
				...
				rpt.generateReport("", "Add address", "", "", "Must Enter all the details", "All the details entered successfully", "Passed", "", true);
				TimeUnit.SECONDS.sleep(3);
		...
		//Click on Submit button
				...
				{
					rpt.generateReport("", "Add address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
		...
		//Click on Confirmation message
				...
				{
					rpt.generateReport("", "Add address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Add address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
