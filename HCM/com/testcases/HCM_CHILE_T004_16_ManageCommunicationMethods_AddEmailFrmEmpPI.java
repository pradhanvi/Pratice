...
/**
Script Name			: HCM_CHILE_T004_16_ManageCommunicationMethods_AddEmailFrmEmpPI
Script Description	: Manage Communication Methods - Add Email from Emp PI
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_16_ManageCommunicationMethods_AddEmailFrmEmpPI extends TestBase {
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_16_ManageCommunicationMethods_AddEmailFrmEmpPI_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_16_ManageCommunicationMethods", "Add Email from Emp PI");

		String strDataSheetName = "T004_16_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_16_ManageCommunicationMethods_AddEmailFrmEmpPI", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_16_ManageCommunicationMethods_AddEmailFrmEmpPI", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Click on Edit Button
			...
			{
				rpt.generateReport("", "Add Email ID", "", "", "Email ID should be added", "Successfully added Email ID", "Passed", "", true);
			}else {
				rpt.generateReport("", "Add Email ID", "", "", "Email ID should be added", "Error occured while adding Email ID", "Failed", "", true);
				Assert.fail("Error occured while adding Email ID");
			}
