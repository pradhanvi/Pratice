...
/**
Script Name			: HCM_CHILE_T003_7_View_Update_PrsnlInfo_DeleteAddress
Script Description	: View and Update Personal Information - Delete Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_7_View_Update_PrsnlInfo_DeleteAddress extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_7_View_Update_PrsnlInfo_DeleteAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_7_View_Update_PrsnlInfo", "Delete Address");

		String strDataSheetName = "T003_7_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_7_View_Update_PrsnlInfo_DeleteAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_7_View_Update_PrsnlInfo_DeleteAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Delete address
				...
				managePerson.clickAddressEditSelectDelete();
				...
				if(cmnLib.waitForElementToBeVisible(managePerson.DeleteConfirmationYes, 10))
				{
					rpt.generateReport("", "Delete Confirmation message", "", "", "Must Click on OK button", "Clicked on OK button", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.DeleteConfirmationYes);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Delete address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Delete address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Delete address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
