...
/**
Script Name			: HCM_CHILE_T004_15_ManageCommunicationMethods
Script Description	: Manage Communication Methods - Add E-Mail from Emp Dir
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_15_ManageCommunicationMethods_AddEmailFrmEmpDir extends TestBase{
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_15_ManageCommunicationMethods_AddEmailFrmEmpDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_15_ManageCommunicationMethods", "Add E-Mail from Emp Dir");

		String strDataSheetName = "T004_15_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_15_ManageCommunicationMethods_AddEmailFrmEmpDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_15_ManageCommunicationMethods_AddEmailFrmEmpDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Email ID
			...
			rpt.generateReport("", "Add Email ID", "", "", "Email details must be entered", "All the required details are entered", "Passed", "", true);
