...
/**
Script Name			: HCM_CHILE_T003_6_View_Update_PrsnlInfo_EndDateAddress
Script Description	: View and Update Personal Information - End Date Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_6_View_Update_PrsnlInfo_EndDateAddress extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_6_View_Update_PrsnlInfo_EndDateAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_6_View_Update_PrsnlInfo_TC", "End Date Address");

		String strDataSheetName = "T003_6_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_6_View_Update_PrsnlInfo_EndDateAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_6_View_Update_PrsnlInfo_EndDateAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//End date address
				...
				managePerson.clickAddressEditSelectEndDate();
				...
				managePerson.EffectiveEndDate.clear();
				managePerson.EffectiveEndDate.sendKeys(managePerson.futureDate("dd/MMM/YYYY",-1));
				rpt.generateReport("", "Click on End Date Address OK Button", "", "", "Must Click on OK button", "Clicked on OK button", "Passed", "", true);
				TimeUnit.SECONDS.sleep(3);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "End date address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "End date address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "End date address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
