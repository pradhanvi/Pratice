...
/**
Script Name			: HCM_CHILE_T004_19_ManageCommunicationMethods_DeleteEmailFrmEmpDir
Script Description	: Manage Communication methods - Delete E-Mail from Emp Dir
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_19_ManageCommunicationMethods_DeleteEmailFrmEmpDir extends TestBase {
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_19_ManageCommunicationMethods_DeleteEmailFrmEmpDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_19_ManageCommunicationMethods", "Delete E-Mail from Emp Dir");

		String strDataSheetName = "T004_19_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_19_ManageCommunicationMethods_DeleteEmailFrmEmpDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_19_ManageCommunicationMethods_DeleteEmailFrmEmpDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Delete Email ID
			...
			if(!cmnLib.clickOnWebElement(managecomm.DeleteEmail_Dir))
			{
