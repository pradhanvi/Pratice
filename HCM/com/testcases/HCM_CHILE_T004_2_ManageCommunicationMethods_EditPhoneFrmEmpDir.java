...
/**
Script Name			: HCM_CHILE_T004_2_ManageCommunicationMethods_EditPhoneFrmEmpDir
Script Description	: Manage Communication Methods - Edit Phone frm Emp Directory
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_2_ManageCommunicationMethods_EditPhoneFrmEmpDir extends TestBase{
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_2_ManageCommunicationMethods_EditPhoneFrmEmpDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_2_ManageCommunicationMethods", "Edit Phone frm Emp Directory");

		String strDataSheetName = "T004_2_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_2_ManageCommunicationMethods_EditPhoneFrmEmpDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_2_ManageCommunicationMethods_EditPhoneFrmEmpDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Edit Phone number
			...
			managecomm.selectOptionFromComboBoxInsideTable(managecomm.TypeDrop, exl.read(strDataSheetName, dataRow, "PhoneType"));
