...
/**
Script Name			: HCM_CHILE_TS006_Create_Action_Reasons_SetupAndMaintenance
Script Description	: Create Action Reason from Setup And Maintenance
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_TS006_Create_Action_Reasons_SetupAndMaintenance extends TestBase {

	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_TS006_Create_Action_Reasons_SetupAndMaintenance_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_TS006_Create_Action_Reasons", "");

		String strDataSheetName = "TS006_Crt_ActionReason";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_TS006_Create_Action_Reasons_SetupAndMaintenance", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_TS006_Create_Action_Reasons_SetupAndMaintenance", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Search Task
			...
			cmnLib.clickOnLinkText("Manage Action Reasons");
			/*
