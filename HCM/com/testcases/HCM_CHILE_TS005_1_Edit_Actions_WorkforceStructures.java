...
/**
Script Name			: HCM_CHILE_TS005_1_Edit_Actions_WorkforceStructures
Script Description	: Edit Action from Workforce Structures
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_TS005_1_Edit_Actions_WorkforceStructures extends TestBase{


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_TS005_1_Edit_Actions_WorkforceStructures_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_TS005_1_Edit_Actions", "");

		String strDataSheetName = "TS005_1_Edit_Action";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_TS005_1_Edit_Actions_WorkforceStructures", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_TS005_1_Edit_Actions_WorkforceStructures", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
