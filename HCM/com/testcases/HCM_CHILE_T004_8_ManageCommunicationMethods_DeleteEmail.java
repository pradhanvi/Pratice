...
/**
Script Name			: HCM_CHILE_T004_8_ManageCommunicationMethods_DeleteEmail
Script Description	: Manage Communication Methods - Delete E-Mail from Admin Dir
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_8_ManageCommunicationMethods_DeleteEmail extends TestBase {
	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T004_8_ManageCommunicationMethods_DeleteEmail_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_8_ManageCommunicationMethods", "Delete E-Mail from Admin Dir");

		String strDataSheetName = "T004_8_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_8_ManageCommunicationMethods_DeleteEmail", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_8_ManageCommunicationMethods_DeleteEmail", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Verify the Entered Person Search Record Exists
			...
			if(cmnLib.waitForElementToBeVisible(managecomm.NoResultsFound, 15)) {
				//Fail
		...
		//Delete Email ID
			...
			if(!cmnLib.clickOnWebElement(managecomm.DeleteEmail_Dir_Ad))
			{
				rpt.generateReport("", "Delete Email ID", "", "", "Email details must be entered", "Delete action on Email is prohibited", "Failed", "", true);
			}
			rpt.generateReport("", "Delete Email ID", "", "", "Email details must be entered", "All the required details are entered", "Passed", "", true);
