...
/**
Script Name			: HCM_CHILE_T003_9_View_Update_PrsnlInfo_UpdatePrimaryAddress
Script Description	: View and Update Personal Information - Update Primary Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_9_View_Update_PrsnlInfo_UpdatePrimaryAddress extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_9_View_Update_PrsnlInfo_UpdatePrimaryAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_9_View_Update_PrsnlInfo", "Update Primary Address");

		String strDataSheetName = "T003_9_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_9_View_Update_PrsnlInfo_UpdatePrimaryAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_9_View_Update_PrsnlInfo_UpdatePrimaryAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Updating Primary Address
				...
				managePerson.clickPrimaryAddressEditSelectUpdate();
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Update Primary Address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Update Primary Address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Update Primary Address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
