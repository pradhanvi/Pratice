...
/**
Script Name			: HCM_CHILE_T004_9_ManageCommunicationMethods_AddPhoneFrmEmpPI
Script Description	: Manage Communication Methods - Add Phone from Emp PI
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_9_ManageCommunicationMethods_AddPhoneFrmEmpPI extends TestBase {
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_9_ManageCommunicationMethods_AddPhoneFrmEmpPI_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_9_ManageCommunicationMethods", "Add Phone from Emp PI");

		String strDataSheetName = "T004_9_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_9_ManageCommunicationMethods_AddPhoneFrmEmpPI", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_9_ManageCommunicationMethods_AddPhoneFrmEmpPI", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Click on Edit Button
			...
			{
				rpt.generateReport("", "Add Phone number", "", "", "Phone number must be added", "Successfully added Phone number", "Passed", "", true);
			}else {
				rpt.generateReport("", "Add Phone number", "", "", "Phone number must be added", "Error occured while adding Phone number", "Failed", "", true);
