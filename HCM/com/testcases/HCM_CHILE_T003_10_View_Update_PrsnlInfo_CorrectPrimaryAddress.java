...
/**
Script Name			: HCM_CHILE_T003_10_View_Update_PrsnlInfo_CorrectPrimaryAddress
Script Description	: View and Update Personal Information - Correct Primary Address
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_10_View_Update_PrsnlInfo_CorrectPrimaryAddress extends TestBase {
	...
	@Test
	public void HCM_CHILE_T003_10_View_Update_PrsnlInfo_CorrectPrimaryAddress_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_10_View_Update_PrsnlInfo", "Correct Primary Address");

		String strDataSheetName = "T003_10_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_10_View_Update_PrsnlInfo_CorrectPrimaryAddress", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_10_View_Update_PrsnlInfo_CorrectPrimaryAddress", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Correcting Primary Address
				System.out.println("Drop down selected");
				managePerson.clickPrimaryAddressEditSelectCorrect();
				TimeUnit.SECONDS.sleep(3);
				cmnLib.waitForElementToBeVisible(managePerson.EffectiveStartDate, 15);
				/*managePerson.EffectiveStartDate.clear();
				managePerson.EffectiveStartDate.sendKeys(managePerson.futureDate("dd/MMM/YYYY",0));
				rpt.generateReport("", "Click on OK Button", "", "", "Must Click on OK button", "Clicked on OK button", "Passed", "", true);
				cmnLib.clickOnWebElement(managePerson.PrimaryAddEffectiveDateOKButton);
				TimeUnit.SECONDS.sleep(3);*/
				
				
		//Selecting Primary Address
				
				cmnLib.waitForElementToBeVisible(managePerson.SelectPrimAddDrop, 15);
				cmnLib.clickOnWebElement(managePerson.SelectPrimAddDrop);
				TimeUnit.SECONDS.sleep(3);
				cmnLib.clickOnWebElement(managePerson.SelectfirstPrimAdd);
				rpt.generateReport("", "Select Primary address", "", "", "Should select Primary address", "Selecting primary address", "Passed", "", true);
				TimeUnit.SECONDS.sleep(2);
				cmnLib.clickOnWebElement(managePerson.PrimAddSelectOKButton);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Correct Primary Address", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Correct Primary Address", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Correct Primary Address", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
