...
/**
Script Name			: HCM_CHILE_T004_14_ManageCommunicationMethods_DeletePhoneFrmEmpPI
Script Description	: Manage Communication Methods - Delete Phone from Emp PI
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_14_ManageCommunicationMethods_DeletePhoneFrmEmpPI extends TestBase {
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_14_ManageCommunicationMethods_DeletePhoneFrmEmpPI_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_14_ManageCommunicationMethods", "Delete Phone from Emp PI");

		String strDataSheetName = "T004_14_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_14_ManageCommunicationMethods_DeletePhoneFrmEmpPI", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_14_ManageCommunicationMethods_DeletePhoneFrmEmpPI", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Click on Edit Button and Delete
			...
			cmnLib.clickOnWebElement(personalInfo.DeletePhoneRow1);
			
			rpt.generateReport("", "Delete Phone number", "", "", "All the details must be entered ", "All the details are entered", "Passed", "", true);
			...
			{
				rpt.generateReport("", "Delete Phone number", "", "", "Phone number must be Deleted", "Successfully Deleted Phone number", "Passed", "", true);
			}else {
				rpt.generateReport("", "Delete Phone number", "", "", "Phone number must be Deleted", "Error occured while deleting Phone number", "Failed", "", true);
