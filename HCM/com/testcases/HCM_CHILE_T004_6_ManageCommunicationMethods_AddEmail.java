...
/**
Script Name			: HCM_CHILE_T004_6_ManageCommunicationMethods_AddEmail
Script Description	: Manage Communication Methods - Add E-Mail
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_6_ManageCommunicationMethods_AddEmail extends TestBase{
	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T004_6_ManageCommunicationMethods_AddEmail_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_6_ManageCommunicationMethods", "Add E-Mail");

		String strDataSheetName = "T004_6_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_6_ManageCommunicationMethods_AddEmail", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_6_ManageCommunicationMethods_AddEmail", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Email ID
			...
			TimeUnit.SECONDS.sleep(5);
			cmnLib.clickOnWebElement(managecomm.HomeEmailSelect);
			TimeUnit.SECONDS.sleep(2);
