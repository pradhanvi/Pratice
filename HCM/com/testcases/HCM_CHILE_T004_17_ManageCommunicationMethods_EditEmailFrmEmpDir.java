...
/**
Script Name			: HCM_CHILE_T004_17_ManageCommunicationMethods_EditEmailFrmEmpDir
...
public class HCM_CHILE_T004_17_ManageCommunicationMethods_EditEmailFrmEmpDir extends TestBase {
	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_17_ManageCommunicationMethods_EditEmailFrmEmpDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_17_ManageCommunicationMethods", "Edit E-Mail from Emp Dir");

		String strDataSheetName = "T004_17_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_17_ManageCommunicationMethods_EditEmailFrmEmpDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_17_ManageCommunicationMethods_EditEmailFrmEmpDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
