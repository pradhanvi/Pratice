...
/**
Script Name			: HCM_CHILE_T004_11_ManageCommunicationMethods_DeletePhoneFrmEmpDir
Script Description	: Manage Communication Methods - Delete Phone number from Emp Dir
Track/Module		: HCM
Sub Track			: 
...
Responsibility		: 
Pre-Requisites		: Atleast one Phone number record must be entered
Comments (if any)	:
 **/

public class HCM_CHILE_T004_11_ManageCommunicationMethods_DeletePhoneFrmEmpDir extends TestBase{


	String strModule = "HCM_EMP";
	
	@Test
	public void HCM_CHILE_T004_11_ManageCommunicationMethods_DeletePhoneFrmEmpDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_11_ManageCommunicationMethods", "Delete Phone from Emp Dir");

		String strDataSheetName = "T004_11_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_11_ManageCommunicationMethods_DeletePhoneFrmEmpDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_11_ManageCommunicationMethods_DeletePhoneFrmEmpDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Email ID
			...
			rpt.generateReport("", "Delete Phone number", "", "", "Phone number should be deleted", "Phone number details before editing", "Passed", "", true);
			TimeUnit.SECONDS.sleep(3);
			cmnLib.clickOnWebElement(managecomm.Delete_PhoneNum_Dir);
