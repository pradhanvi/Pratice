...
/**
Script Name			: HCM_CHILE_T004_1_ManageCommunicationMethods_AddPhoneFrmDir
Script Description	: Manage Communication Methods - Add Phone num frm Directory
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_1_ManageCommunicationMethods_AddPhoneFrmDir extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T004_1_ManageCommunicationMethods_AddPhoneFrmDir_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_1_ManageCommunicationMethods", "Add Phone num frm Directory");

		String strDataSheetName = "T004_1_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_1_ManageCommunicationMethods_AddPhoneFrmDir", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_1_ManageCommunicationMethods_AddPhoneFrmDir", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Phone number
			...
			driver.findElement(By.xpath("//ul[contains(@id,'1:soc1::pop')]//li[text()='Home Phone']")).click();
