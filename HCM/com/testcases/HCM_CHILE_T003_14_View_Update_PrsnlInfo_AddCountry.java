...
/**
Script Name			: HCM_CHILE_T003_14_View_Update_PrsnlInfo_AddCountry
Script Description	: View and Update Personal Information - Add Country
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T003_14_View_Update_PrsnlInfo_AddCountry extends TestBase {


	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T003_14_View_Update_PrsnlInfo_AddCountry_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T003_14_View_Update_PrsnlInfo", "Add Country");

		String strDataSheetName = "T003_14_ViewUpdate_PrsnInfo";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T003_14_View_Update_PrsnlInfo_AddCountry", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T003_14_View_Update_PrsnlInfo_AddCountry", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
		...
		//Add Country
					...
					cmnLib.clickOnWebElement(managePerson.AddCountryButton);
					cmnLib.waitForElementToBeVisible(managePerson.AddDataCountry, 10);
					cmnLib.enterDataInTextBox(managePerson.AddDataCountry, exl.read(strDataSheetName, dataRow, "AddDataCountry"), true);
					rpt.generateReport("", "Add Country", "", "", "Should Enter all the required details", "All the required details are entered", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.AddCountryOK);
		...
		//Submit 
				...
				{
					rpt.generateReport("", "Add Country", "", "", "Warning message must Pop up", "Warning message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
		...
		//Confirmation
				...
				{
					rpt.generateReport("", "Add Country", "", "", "Confirmation message must Pop up", "Confirmation message is Popping up", "Passed", "", true);
					TimeUnit.SECONDS.sleep(3);
					cmnLib.clickOnWebElement(managePerson.Ok_Confirmation);
				}else {
					rpt.generateReport("", "Add Country", "", "", "Confirmation message must Pop up", "Confirmation message has not Popped up", "Failed", "", true);
