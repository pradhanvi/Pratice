...
/**
Script Name			: HCM_CHILE_T004_7_ManageCommunicationMethods
Script Description	: Manage Communication Methods - Edit E-Mail
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_T004_7_ManageCommunicationMethods_EditEmail extends TestBase{
	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_T004_7_ManageCommunicationMethods_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_T004_7_ManageCommunicationMethods", "Edit E-Mail");

		String strDataSheetName = "T004_7_ManageCommMthds";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_T004_7_ManageCommunicationMethods", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_T004_7_ManageCommunicationMethods", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
			Assert.fail("Login Un-Successful");
		}
