...
/**
Script Name			: HCM_CHILE_TS008_Edit_Manage_Contacts
Script Description	: Edit Manage Contacts
Track/Module		: HCM
Sub Track			: 
...
public class HCM_CHILE_TS008_Edit_Manage_Contacts extends TestBase{

	String strModule = "HCM";
	
	@Test
	public void HCM_CHILE_TS008_Edit_Manage_Contacts_TC() throws Throwable {
		rpt = new ReportGeneration("HCM_CHILE_TS008_Edit_Manage_Contacts", "Edit Manage Contacts");

		String strDataSheetName = "TS008_Edit_Manage_Contacts";
		...
		if(cmnLib.waitForElementToBeVisible(homePage_HCM.HomePage_HomeIcon) == true)
		{
			...
			//PASS
			rpt.generateReport("HCM_CHILE_TS008_Edit_Manage_Contacts", "Enter URL", "", "Password: "+hashmap.get("URL_"+strModule), "URL should be entered", "URL is entered", "Info", "", true );
		...
		{
			//FAIL
			rpt.generateReport("HCM_CHILE_TS008_Edit_Manage_Contacts", "Login to Appication", "", "UserName: "+exl.read("LoginDetails", 1, "UserName"), "Login Should be successful", "Login Is Not Successful", "Failed", "", true );
		...
		//Selecting the Contact to edit
			if(benefitsEnrollment.ClickOnSearchedResults(exl.read(strDataSheetName, dataRow, "PaternalLastName_Edit")) == true)
			{
		...
		//Edit Contacts
			...
			cmnLib.enterDataInTextBox(benefitsEnrollment.UpdateDate, exl.read(strDataSheetName, dataRow, "RelationshipStartDate"), true);
			cmnLib.enterDataInTextBox(benefitsEnrollment.PaternalLastName, exl.read(strDataSheetName, dataRow, "PaternalLastName_Edit"), true);
			...
			rpt.generateReport("", "Adding Contacts", "", exl.read(strDataSheetName, dataRow, "PaternalLastName_Edit"), "Contact details must be successfully entered", "Contacts details are successfully entered", "Passed", "", true);
